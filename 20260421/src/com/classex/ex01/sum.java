 ...
 * 
 * 			main() 메소드는 1978년, 스웨덴 국적의 ABBA가 부른 Dancing Queen을
...
//			System.out.println(year + "년 " +country +" 국적의 " + artist +"가 부른 " + title);
		...
		public sum(String title,String artist,int year,String country) {
			this.title = title;
			this.artist = artist;
			this.year = year;
		...
		public static void main(String[] args) {
			sum su = new sum("Dancing Queen","ABBA",1978,"스웨덴");
			su.show();
		}
}
